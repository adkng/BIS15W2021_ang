...
amniota %>% 
  miss_var_summary()
```
This doesn't make sense, because the `NA` value for this data frame is `-999.00`, of which I saw a lot... so there is definitely more than 0 missing data for all of these.
