...
Notice that `max_life` has no NA's. Does that make sense in the context of this data? Do we really know all the life spans of the animals in our data?
```{r}
hist(life_history_tidy$max_life)
```
So many mammals in our data frame have a maximum life of 0?! That's a little funny...
...
naniar::miss_var_summary(life_history_tidy)
```
Look, now max_life has the second most missing data!
